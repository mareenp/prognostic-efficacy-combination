...
write.table(as.data.frame(summary_results$eventrate),   file="results/summary_eventrate.csv", sep=";", row.names = FALSE)
write.table(as.data.frame(summary_results$samplesize),  file="results/summary_samplesize.csv", sep=";", row.names = FALSE)
write.table(as.data.frame(summary_results$biomarker),   file="results/summary_biomarker.csv", sep=";", row.names = FALSE)
write.table(as.data.frame(summary_results$sensitivity), file="results/summary_sensitivity.csv", sep=";", row.names = FALSE)