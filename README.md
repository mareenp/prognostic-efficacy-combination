...
Clone the repository and run "PEC-D-CV_Application.R" for example application of the resampling version of the prognostic-efficacy-combination design or use the code for custom data. 
